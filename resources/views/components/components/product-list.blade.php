        ...
        <div class="flex flex-col flex-1 px-6 py-4">
            ...
            <div>
                ...
                <div class="p-8">
                    ...
                    <div class="flex items-center justify-between {{-- mt-auto --}}">
                        ...
                        <h1 class="font-semibold tracking-wide text-black uppercase md:text-lg">{{ $product->name }}
                        </h1>
                    ...
                    <p class="mt-2 text-black md:mt-6">{!! Str::limit($product->description, 100) !!}</p>
            ...
            <div class="flex items-center justify-between mt-auto ">
                ...
                <x-components.button-enlace class="px-4" href="{{ route('products.show', $product) }}">
                    Detalles {{-- <img class="ml-2" src="https://img.icons8.com/dusk/20/000000/vip.png" /> --}}
                </x-components.button-enlace>

                <div class="font-semibold text-center text-black sm:text-left">
                    US ${{ $product->price }}
                </div>

    ...
    <x-slot name="header">
        ...
        <div class="flex items-center justify-between">                            
            ...
            <h1 class="flex items-center font-semibold leading-tight text-gray-800 md:text-2xl">
                ...
                <a href="{{ route('admin.departments.index') }}" class="mr-2"><i class="fa fa-arrow-left text-sm" aria-hidden="true"></i></a>
 
                <a href="{{ URL::previous() }}" class="mr-2"><i class="fa fa-arrow-right text-sm" aria-hidden="true"></i></a>Estado: {{$department->name}} 
            </h1>            

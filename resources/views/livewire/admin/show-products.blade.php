                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col"
                                class="px-6 hidden py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase">
                                Precio Vip
                            </th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @foreach ($products as $product) 
                            ...
                            <tr>
                                ...
                                <td class=" hidden px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
                                    US ${{$product->price}}
                                </td>

        ...
        <div class="px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                ...
                <h1 class="flex items-center font-semibold leading-tight text-gray-800 md:text-2xl">
                    ...
                    <a href="{{ route('admin.subscriptions.index') }}" class="mr-2"><i
                            class="fa fa-arrow-left text-sm" aria-hidden="true"></i>
                        <a href="{{ route('admin.subscriptions.create') }}" class="mr-2"><i
                                class="fa fa-arrow-right text-sm" aria-hidden="true"></i></a>Suscripciones
                </h1>

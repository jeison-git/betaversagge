<div class="max-w-4xl px-4 py-12 mx-auto text-gray-700 sm:px-6 lg:px-8">
    ...
    <h1 class="flex items-cente">
        <a href="{{ route('admin.subscriptions.index') }}" class="mr-2 flex items-center"><i
                class="fa fa-arrow-left text-sm" aria-hidden="true"></i>
            <a href="{{ URL::previous() }}" class="mr-2"><i class="fa fa-arrow-right text-sm" aria-hidden="true"></i></a>
    </h1>

    <h1 class="mb-8 text-3xl font-semibold text-center">Complete la siguiente información para crear una Suscripción a
        nuestro servicio.</h1>

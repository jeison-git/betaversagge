<div>
    <header class=" bg-white shadow">
        ...
        <div class="py-6 max-w-7xl mx-auto">
            <div class=" flex justify-between items-center">
                <h1 class=" font-semibold text-xl text-trueGray-800 leading-tight"> <a href="{{ route('admin.index') }}"> Productos</a></h1>
    ...
    <div class=" py-12 max-w-4xl mx-auto">
        <h1 class="text-xl lg:text-3xl text-center font-semibold mb-8">Proporcione la información necesaria para agregar un producto
        </h1>
        ...
        <div class=" rounded-lg shadow-xl text-trueGray-700 bg-gray-50 p-6">
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-4">
                ...
                {{-- REALPrice --}}
                <div>
                    <x-jet-label value="{{ __('Confirmar Precio') }}" />
                    <x-jet-input type="number" step=".01" class="w-full"

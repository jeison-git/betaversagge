        ...
        <div class="px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                ...
                <h1 class="flex items-center font-semibold leading-tight text-gray-800 md:text-2xl">
                    <a href="{{ route('admin.commerces.index') }}" class="mr-2"><i class="fa fa-arrow-left text-sm"
                            aria-hidden="true"></i>
                    </a> Resgistro de Comercios
                </h1>
    ...
    <div class="container py-12">
        ...
        <x-jet-form-section submit="save" class="mb-6">
            ...
            <x-slot name="form">
                ...
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label>
                        ¿Qué tipo de negocio es y a quién va dirigido su servicio o producto?
                    </x-jet-label>
                ...
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label>
                        ¿Tiene página web o perfil de Instagram?

                        Si no, puede proporcionar el enlace a un sitio web de referencia, como https://versagge.com/.
                    </x-jet-label>

                    <x-jet-input wire:model="createForm.url" type="text" class="w-full mt-1"
                        placeholder="ejemplo: https://versagge.com/ " />
                ...
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label>
                        Proporcionar un lema o descripción breve del negocio.
                    </x-jet-label>
                ...
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label>
                        Proporcionar la dirección exacta del negocio, incluyendo los puntos de referencia más cercanos.
                    </x-jet-label>
        ...
        <x-jet-action-section>
            ...
            <x-slot name="description">
                Puede encontrar una lista de todos los comercios aliados agregados en esta secciòn.
            </x-slot>
        ...
        <x-jet-dialog-modal wire:model="editForm.open">
            ...
            <x-slot name="content">
                ...
                <div class="space-y-3">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        <x-jet-label>
                            Actualizar ¿Tiene página web o perfil de Instagram?

                            Si no, puede proporcionar el enlace a un sitio web de referencia, como https://versagge.com/.
                        </x-jet-label>

                        <x-jet-input wire:model="editForm.url" type="text" class="w-full mt-1"
                            placeholder="ejemplo: https://meganegociosvip.com/ " />
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        <x-jet-label>
                            Proporcionar la ubicación exacta del negocio, incluyendo los puntos de referencia más cercanos.
                        </x-jet-label>

<div> 
    ...
    <x-jet-form-section submit="save" class="mb-6">
        ...
        <x-slot name="description">
            Ingrese la información necesaria para agregar un nuevo comercio
        </x-slot>
    ...
    <x-jet-action-section>
        ...
        <x-slot name="description">
            Aquí encontrará todos los comercios agregados
        </x-slot>
    ...
    <x-jet-dialog-modal wire:model="editForm.open">
        ...
        <x-slot name="title">
            Editar o actualizar un comercio
        </x-slot>

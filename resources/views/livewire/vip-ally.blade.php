<div class="mt-12">
    ...
    <section class="container py-8">
        ...
        @forelse ($claims as $claim)
            {{-- itera el foreach.. la condicional @if agrega la propiedad de alpine x-data= open:false a cada registro encontrado excepto al primero. --}}
    ...
    @push('script')
        {{-- scrip utilizado por el slider de glider --}}
        <script>

                    ...
                    <li
                        ...
                        <article>
                            <figure>
                                ...
                                <img style="object-fit: fill;"class="object-center {{-- w-80  --}}h-80 {{-- rounded-t-md --}}"
                            ...
                            <div cclass="mt-4">
                                ...
                                <h1
                                    class="text-base font-semibold text-black underline transition duration-300 hover:text-gold hover:shadow-md">

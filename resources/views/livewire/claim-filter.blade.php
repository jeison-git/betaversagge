    ...
    <section class="py-16">
        ...
        <div class="bg-white {{-- rounded-lg --}} shadow-lg">
            ...
            <div class="flex items-center justify-between px-6 py-2">
                ...
                {{-- prueba  filtros --}}
                <div class="container topbar-menu-area text-black">
                            ...
                            <div class="flex flex-col items-center justify-center h-full">
                                ...
                                <div
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <p class="flex items-center py-2 text-sm text-black"><img
                                                class="mr-2"
                                        ...
                                        <button
                                            class="block w-full px-6 py-2 text-lg font-semibold text-black transition duration-300 {{-- rounded-lg --}} shadow bg-gold hover:text-white hover:shadow-md">
                                            <a href="{{ route('products.show', $product) }}">
                                                Más detalles
                                            </a>
                                        </button>

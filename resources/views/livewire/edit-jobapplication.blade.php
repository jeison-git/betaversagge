<div>
    ...
    <header class="bg-white shadow"> {{-- Cabezera --}}
        <div class="px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                ...
                <h1 class="flex items-center font-semibold leading-tight text-black md:text-2xl">
    ...
    <div class="max-w-4xl px-4 py-12 mx-auto text-black  sm:px-6 lg:px-8">
        ...
        <div class="px-6 mb-4 text-center bg-white border-b">
            <p class="leading-loose text-center text-black">
        ...
        <div class="p-6 bg-white {{-- rounded-lg --}} shadow-md">
            ...
            <div class="mb-4">
                <div wire:ignore>
                    ...
                    <textarea class="w-full form-control" rows="4" wire:model.defer="application.address" x-data
            ...
            <div class="p-6 mb-4 bg-white rounded-lg shadow-sm"> {{-- bilingue --}}
                ...
                <div class="flex items-center justify-center">
                    <label class="mr-6">
                        <input wire:model.defer="application.bilingue" type="radio" name="bilingue"
                            value="1">
                        Si
                    </label>
                    <label>
            ...
            <div class="grid gap-6 mb-4 sm:grid-cols-1 md:grid-cols-2">
                ...
                <div class="mb-4">
                    <div wire:ignore>
                        ...
                        <textarea class="w-full form-control" rows="4" wire:model.defer="application.courses" x-data
                            x-init="ClassicEditor.create($refs.miapplications, {
                                    toolbar: ['heading', '|', 'bold', 'italic', 'blockQuote', 'insertTable', 'link', 'numberedList', 'bulletedList', '|', 'undo', 'redo'],
                                })
                                .then(function(editor) {
                                    editor.model.document.on('change:data', () => {
            ...
            <div class="mb-4">
                <div wire:ignore>
                    ...
                    <textarea class="w-full form-control" rows="4" wire:model.defer="application.skills" x-data
                        x-init="ClassicEditor.create($refs.miSkills, {
                                toolbar: ['heading', '|', 'bold', 'italic', 'blockQuote', 'insertTable', 'link', 'numberedList', 'bulletedList', '|', 'undo', 'redo'],
                            })
                            .then(function(editor) {
                                editor.model.document.on('change:data', () => {
        ...
        <div class="mt-8">
            @livewire('employment-curriculum', ['application' => $application], key('employment-curriculum-' . $application->id))

            @livewire('employment-references', ['application' => $application], key('employment-references-' . $application->id))
        </div>
        ...
        <aside class="p-6 mt-8 mb-4 bg-gray-300 {{-- rounded-lg --}} shadow-xl">{{-- respuesta a la solicitud de empleo y estatus de la solicitud --}}
            ...
            <div class="p-6 mb-4 bg-white {{-- rounded-lg --}} shadow-xl"> {{-- respuesta de la solicitud --}}
                ...
                @if ($application->application)
                    {{-- ojo este es el componente Observer --}}
            ...
            @switch($application->status ?? null)
                @case(1)
                    ...
                    @livewire('status-application', ['application' => $application], key('status-application-' . $application->id))
                @break

                @case(2)
                    <div class="font-semibold text-center text-black card">
                        <div class="card-body">

    ...
    <div class=" justify-center min-h-screen mx-0 sm:flex sm:flex-row">
        ...
        <div class="relative z-10 flex flex-col self-center p-10 md:max-w-2xl">
            ...
            <div class="flex-col self-start text-white lg:flex">
                <img src="" class="mb-3">
                <strong class="mb-3 font-bold md:text-3xl">Hola, 👋</strong>
                <p class="pr-3 text-justify">Bienvenido a la bolsa de empleos de Versagge Elegance C.A. <br>
                    <br> Somos una empresa comprometida con la innovación, la inclusión y la sustentabilidad económica.
                    Para promover un crecimiento económico generalizado y la creación de empleos productivos con
                    igualdad de oportunidades, valoramos y revisamos todas las solicitudes según los méritos del
                    solicitante en relación con su perfil profesional. <br>
                    <br> Si tu perfil coincide con los requisitos de alguna de nuestras vacantes, nos pondremos en
                    contacto
                    contigo. <br>
                </p>
            </div>
                        ...
                        @if ($applications->count())
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        <th scope="col"
                                            class="px-6 py-3 text-xs font-medium tracking-wider text-center text-black uppercase">
                                            Nombre
                                        </th>
                                        <th scope="col"
                                            class="px-6 py-3 text-xs font-medium tracking-wider text-center text-black uppercase">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 text-center whitespace-nowrap">{{-- Estado del curso si es aprobado o no --}}
                                                ...
                                                @switch($application->status)
                                                    ...
                                                    @case(2)
                                                        <span
                                                            class="inline-flex px-2 text-xs font-semibold leading-5 text-yellow-500 bg-yellow-300 rounded-full">
                                                            Revisión
                                                        </span>
                                                    @break

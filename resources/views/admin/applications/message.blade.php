            ...
            <div class="px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="flex items-center justify-between">
                    <h1 class="flex items-center font-semibold leading-tight text-gray-800 md:text-2xl">
                        <a href="{{ URL::previous() }}" class="mr-2 items-center flex"><i class="fa fa-arrow-left text-sm"
                                aria-hidden="true"></i></a>Responder Solicitud
                    </h1>
                </div>
            </div>
        </header>
            ...
            <div class="p-6 bg-white rounded-lg shadow-xl">
                ...
                <div class="mb-4">
                    <div>
                        ...
                        <form action="{{ route('admin.applications.approved', $application) }}" method="POST"

          ...
          <![endif]-->
                    <table role="presentation"
                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                ...
                                <br>
                                <h3
                                    style="margin-top:0;margin-bottom:8px;text-align:center;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;">
                                    Le notificamos que su solicitud ha sido revisada minuciosamente y queremos
                ...
                <![endif]-->
                                <div class="col-sml"
                                    ...
                                    <img src="{{ $application->unemployed->profile_photo_url ?? null }}" width="115"
                ...
                <![endif]-->
                                <div class="col-lge"
                                    ...
                                    <p style="margin-top:0;margin-bottom:8px;">Estimado
                                        {{ $application->unemployed->name ?? null }}</p>
                                    <p style="margin-top:0;margin-bottom:12px;text-align:justify;">
                                        {!! $application->application->body ?? null !!}</p>
                                </div>
                                <!--[if mso]>
                </td>
                </tr>
                ...
                <![endif]-->
                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                <p style="margin:0;">Con mucho cariño, el equipo de trabajo de Versagge Elegance C.A.
                                    agradece su preferencia por nuestros servicios.</p>
                            </td>
                        </tr>
                        <tr>
                            <td
                                ...
                                <p style="margin:0;font-size:14px;line-height:20px;"> Copyright &reg; 2023 Versagge C.A.
                                    All rights reserved<br><a class="unsub" href="https://versagge.com/"

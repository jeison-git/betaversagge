                    ...
                    <table role="presentation"
                        ...
                        <tr>
                            <td style="padding:40px 30px 30px 30px;text-align:center;font-size:24px;font-weight:bold;">
                                <a href="https://versagge.com/" style="text-decoration:none;"><img
                                        src="{{ asset('img/vlogotres.png') }}" width="165" alt="Logo"
                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                <h1
                                    ...
                                    ¡Agradecemos su confianza en nuestro trabajo!</h1>
                                <br>
                                <h3
                                ...
                                <p style="margin:0;margin-bottom:8px;text-align:justify;">Nos comentó que <a
                                        style="color:#e50d0d;text-decoration:underline;">{{ $contact->issue }}</a>,
                                        su consulta es de gran importancia para nosotros. Esperamos que esta respuesta sea de su satisfacción y que le sea de utilidad...</p>
                                <p style="margin-top:0;margin-bottom:12px;text-align:justify;">{!! $contact->answer->body !!}
                                </p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                <p style="margin:0;">Con mucho cariño el equipo de trabajo Versagge Elegance C.A.</p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td
                                ...
                                <p style="margin:0 0 8px 0;"><a
                                        href="https://www.facebook.com/people/Versagge-Elegance-Alquiler-de-Trajes/100067775966516/"
                                        style="text-decoration:none;"><img
                                            src="https://assets.codepen.io/210284/facebook_1.png" width="40"
                                            height="40" alt="f"
                                            style="display:inline-block;color:#cccccc;"></a> <a
                                        href="https://twitter.com/trajesversagge" style="text-decoration:none;"><img
                                            src="https://assets.codepen.io/210284/twitter_1.png" width="40"
                                            height="40" alt="t"
                                            style="display:inline-block;color:#cccccc;"></a> <a
                                        href="https://www.instagram.com/trajesversagge/"
                                        style="text-decoration:none;"><img
                                ...
                                <p style="margin:0;font-size:14px;line-height:20px;"> Copyright &reg; 2023 Versagge Elegance C.A. All
                                    rights reserved<br><a class="unsub" href="https://versagge.com/"
